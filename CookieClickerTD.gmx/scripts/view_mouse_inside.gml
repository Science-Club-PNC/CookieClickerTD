...
if (view == view_stats)
{
    var mouse_in_build = point_in_rectangle(window_mouse_get_x(), 
        ...
        view_yport[view] + obj_stats_controller.build_height);
    var mouse_in_stats = point_in_rectangle(window_mouse_get_x(), 
        window_mouse_get_y(), 
        view_xport[view] + obj_stats_controller.stats_max_width - obj_stats_controller.stats_width, 
        view_yport[view], 
        view_xport[view] + view_wport[view], 
...
if ((view == view_game) and view_mouse_inside(view_stats))
{
    return false
}
